...
module mysystem_mm_interconnect_0 (
	...
	wire  [125:0] onchip_memory2_0_s1_agent_rf_source_data;                // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [125:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;             // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [124:0] onchip_memory2_0_s1_agent_rp_data;                       // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [106:0] sdram_s1_agent_rp_data;                                  // SDRAM_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [124:0] onchip_memory2_0_s1_burst_adapter_source0_data;          // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [106:0] sdram_s1_burst_adapter_source0_data;                     // SDRAM_s1_burst_adapter:source0_data -> SDRAM_s1_agent:cp_data
	...
	wire  [124:0] router_002_src_data;                                     // router_002:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [232:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;          // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [106:0] router_003_src_data;                                     // router_003:src_data -> SDRAM_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                    // SDRAM_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                  // router_003:src_channel -> SDRAM_s1_rsp_width_adapter:in_channel
	...
	wire  [232:0] sdram_s1_rsp_width_adapter_src_data;                     // SDRAM_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                    // rsp_demux_001:sink_ready -> SDRAM_s1_rsp_width_adapter:out_ready
	wire    [1:0] sdram_s1_rsp_width_adapter_src_channel;                  // SDRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [232:0] cmd_mux_src_data;                                        // cmd_mux:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire  [124:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;          // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [232:0] cmd_mux_001_src_data;                                    // cmd_mux_001:src_data -> SDRAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                   // SDRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                 // cmd_mux_001:src_channel -> SDRAM_s1_cmd_width_adapter:in_channel
	...
	wire  [106:0] sdram_s1_cmd_width_adapter_src_data;                     // SDRAM_s1_cmd_width_adapter:out_data -> SDRAM_s1_burst_adapter:sink0_data
	...
	mysystem_mm_interconnect_0_router router_001 (
	...
	mysystem_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
